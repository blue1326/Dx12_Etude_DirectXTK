...
Engine::System::DxDevice::DxDevice(DXGI_FORMAT backBufferFormat /*= DXGI_FORMAT_B8G8R8A8_UNORM*/,
...
Engine::System::DxDevice::~DxDevice()
{
	WaitForGpu();
}

std::shared_ptr<Engine::System::DxDevice> Engine::System::DxDevice::CreateDevice(DXGI_FORMAT backBufferFormat /*= DXGI_FORMAT_B8G8R8A8_UNORM*/, DXGI_FORMAT depthBufferFormat /*= DXGI_FORMAT_D32_FLOAT*/, UINT backBufferCount /*= 2*/, D3D_FEATURE_LEVEL minFeatureLevel /*= D3D_FEATURE_LEVEL_11_0*/, unsigned int flags /*= 0*/)
{
	shared_ptr<DxDevice> inst = shared_ptr<DxDevice>(new DxDevice(backBufferFormat, depthBufferFormat, backBufferCount, minFeatureLevel, flags));
	return inst;
}


void Engine::System::DxDevice::CreateDeviceResources()
{
#if defined(_DEBUG)
	...
	// it is not nessesary
	m_d3dDevice->SetName(L"DxDevice");
	...
	m_commandQueue->SetName(L"DxDevice");
	...
	m_rtvDescriptorHeap->SetName(L"DxDevice");
	...
	if (m_depthBufferFormat != DXGI_FORMAT_UNKNOWN)
	{
		...
		m_dsvDescriptorHeap->SetName(L"DxDevice");
	}
	...
	m_commandList->SetName(L"DxDevice");
...
void Engine::System::DxDevice::CreateWindowSizeDependentResources()
{
	if (!m_window)
	{
...
void Engine::System::DxDevice::SetWindow(HWND window, int width, int height)
{
	m_window = window;
...
bool Engine::System::DxDevice::WindowSizeChanged(int width, int height)
{
	RECT newRc;
...
void Engine::System::DxDevice::HandleDeviceLost()
{
	if (m_deviceNotify)
	{
...
void Engine::System::DxDevice::Prepare(D3D12_RESOURCE_STATES beforeState /*= D3D12_RESOURCE_STATE_PRESENT*/)
{
...
void Engine::System::DxDevice::Present(D3D12_RESOURCE_STATES beforeState /*= D3D12_RESOURCE_STATE_RENDER_TARGET*/)
{
...
void Engine::System::DxDevice::WaitForGpu() noexcept
{
...
void Engine::System::DxDevice::MoveToNextFrame()
{
...
void Engine::System::DxDevice::GetAdapter(IDXGIAdapter1** ppAdapter)
{
	*ppAdapter = nullptr;
...
void Engine::System::DxDevice::UpdateColorSpace()
{
